...
def mongo_export_col(client: pymongo.MongoClient, fname: str, databases: str, verbose: bool):
    """
    :param client:
    :param fname:
    :return:
...
def main(argv=sys.argv):
    ...
    parser.add_argument("--host", metavar='h', type=str, help='Server host', default='insearch-docdb-preprod.cluster-cx0j3oma32zw.ap-south-1.docdb.amazonaws.com')
    parser.add_argument("--port", metavar='p', type=int, help='Server port', default=27017)
    parser.add_argument('--username', metavar='u', type=str, help='Username', default='preprod')
    parser.add_argument('--password', metavar='pwd', type=str, help='Password', default='PreProd12search')
    ...
    parser.add_argument('--databases', metavar='db', type=str,
                        help='Databases separated by a comma, eg: db_1,db_2,db_n', default='insearch-preprod-0')
    ...
    s = mongo_export_col(_client, args.file, args.databases, args.verbose)
    if args.verbose:
        print(s)
